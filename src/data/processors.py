...
class MR(AbstractProcessor):
    ...
    def get_sentence_parts(self, example, mask_length):
        if not self.with_pattern:
            return [Text(text=example["source"], shortenable=True)] + mask_length * [
...
class BoolQ(AbstractProcessor):
    ...
    def get_prompt_parts(self, example, mask_length):
        ...
        if self.pattern_id < 2:
            ...
            return [
                passage,
                Text(text=". Based on the previous passage, "),
                question,
                Text(text="?"),
                *masks,
                Text(text="."),
            ...
            return [
                Text(text="Based on the following passage, "),
                question,
                Text(text="?"),
                *masks,
                Text(text="."),
...
class RTE(AbstractProcessor):
    ...
    def get_sentence_parts(self, example, mask_length):
        if not self.with_pattern:
            ...
            if self.mask_position is None:
                return [
                    Text(text=example["premise"], shortenable=True),
                    Text(text=example["hypothesis"], shortenable=True),
                    *masks,
                ], []
            else:
                return self.get_parts_with_setting_masks(
                    part_0=[Text(text=example["premise"], shortenable=True)],
    ...
    def get_prompt_parts(self, example, mask_length):
        ...
        hypothesis = Text(
            text=example["hypothesis"].rstrip(string.punctuation), shortenable=True
        )
        hypothesis_with_punctuation = Text(text=example["hypothesis"], shortenable=True)
        masks = mask_length * [Text(text=self.mask_token)]

        if self.pattern_id == 0:
            return [Text(text='"'), hypothesis, Text(text='" ?')], [
                *masks,
                Text(text=', "'),
                premise,
                Text(text='"'),
        ...
        if self.pattern_id == 2:
            ...
            return [
                premise,
                Text(text=" question: "),
                hypothesis_with_punctuation,
                Text(text=" True or False? answer:"),
                *masks,
            ], []
    ...
    def get_prompt_parts(self, example, mask_length):
        if self.pattern_id == 4:
            ...
            return [
                ...
                Text(text=" question: "),
                hypothesis,
                Text(text=" true, false or neither? answer:"),
                *masks,
            ], []
...
class WiC(AbstractProcessor):
    ...
    def get_sentence_parts(self, example, mask_length):
        if not self.with_pattern:
            ...
            if self.mask_position is None:
                return [
                    Text(text=example["sentence1"], shortenable=True),
    ...
    def get_prompt_parts(self, example, mask_length):
        ...
        if self.pattern_id == 0:
            return [
                ...
                Text(text='" / "'),
                sentence2,
                Text(text='" Similar sense of "' + word + '"?'),
                *masks,
                Text(text="."),
            ], []
        if self.pattern_id == 1:
            return [
                sentence1,
                sentence2,
                Text(text="Does " + word + " have the same meaning in both sentences?"),
                *masks,
            ], []
        if self.pattern_id == 2:
            return [
...
class QNLI(AbstractProcessor):
        ...
        if not self.with_pattern:
            ...
            if self.mask_position is None:
                return [Text(text=example["question"], shortenable=True)] + [
                    Text(text=example["sentence"], shortenable=True)
                ] + masks, []
            else:
                return self.get_parts_with_setting_masks(
                    part_0=[Text(text=example["sentence"], shortenable=True)],
    ...
    def get_prompt_parts(self, example, mask_length):
        ...
        if self.pattern_id < 2:
            ...
            return [
                sentence,
                Text(text=". Based on the previous sentence, "),
                question,
                Text(text="?"),
                *masks,
                Text(text="."),
            ...
            return [
                Text(text="Based on the following sentence, "),
                question,
                Text(text="?"),
                *masks,
                Text(text="."),
        ...
        if not self.with_pattern:
            ...
            if self.mask_position is None:
                return [Text(text=example["question1"], shortenable=True)] + [
                    Text(text=example["question2"], shortenable=True)
                ] + masks, []
            else:
                return self.get_parts_with_setting_masks(
                    part_0=[Text(text=example["question1"], shortenable=True)],
    ...
    def get_prompt_parts(self, example, mask_length):
        ...
        if self.pattern_id < 2:
            return [
                ...
                Text(text=" and "),
                question2,
                Text(text=" have the same meaning? "),
                *masks,
                Text(text="."),
            ], []
        elif self.pattern_id < 4:
            return [
                question1,
                Text(text=". Based on the previous question, "),
                question2,
                Text(text="?"),
                *masks,
                Text(text="."),
            ...
            return [
                Text(text="Based on the following question, "),
                question1,
                Text(text="?"),
                *masks,
                Text(text="."),
    ...
    def get_sentence_parts(self, example, mask_length):
        if not self.with_pattern:
            ...
            if self.mask_position is None:
                ...
                return self.get_parts_with_setting_masks(
                    part_0=[Text(text=example["sentence1"], shortenable=True)],
                    part_1=[Text(text=example["sentence2"], shortenable=True)],
                    masks=masks,
                )
        return self.get_prompt_parts(example, mask_length)
